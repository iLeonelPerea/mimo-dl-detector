# -*- coding: utf-8 -*-
"""training_2x2_detector_OneHot.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kGhWwhROUkbA0wUtkRYA5PqxtqzK-A7m

# MIMO 2x2 Deep Learning Detector Training - One-Hot Encoding Strategy

## Description
This notebook implements a Deep Learning-based detector for a 2x2 MIMO communication system using **one-hot encoding** labeling strategy. The implementation uses PyTorch and is based on the MATLAB code from the paper:
...
SNR_dB = 3          # SNR in dB for training data
...
def generate_training_data(N, symbol_combinations, SNR_linear, No, Nr, Nt):
    """
    ...
    for i in range(N):
        ...
        # Generate Rayleigh fading channel: H ~ CN(0, 1)
        # H is complex Gaussian with variance 0.5 for real and imaginary parts
        ...
        n = n / np.sqrt(SNR_linear)  # Scale noise according to SNR
...
X_data, random_indices = generate_training_data(
    N, symbol_combinations, SNR_linear, No, Nr, Nt
)
...
axes[0].hist(X_data.numpy().flatten(), bins=50, alpha=0.7, color='blue', edgecolor='black')
...
# After normalization
axes[1].hist(X_data_normalized.numpy().flatten(), bins=50, alpha=0.7, color='green', edgecolor='black')
