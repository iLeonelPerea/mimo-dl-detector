...
This document describes a Deep Learning-based MIMO detector using **label/symbol encoding** strategy. This encoding approach uses only **4 output neurons** instead of 16 (one-hot) or 8 (one-hot per antenna).
